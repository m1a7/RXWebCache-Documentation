...
Чем больше вы укажите ссылок в массиве `urls`, тем дольше будет производиться тестирование. <br>По умолчанию тестирование 20 картинок занимает около 5 минут.
